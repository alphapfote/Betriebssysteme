...
//  Beschreibt die Blöcke des File-Systems, nicht manuell schreiben
//
...
int BlockDevice::write(u_int32_t blockNo, char *buffer) { //Blocknummer, Größe des Blocks 512 Byte lang, Wichtig: richtig allokieren
	seekto(this->contFile, blockNo);
